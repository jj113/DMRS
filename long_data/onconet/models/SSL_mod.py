...
@RegisterModel("SSL_mod")
class SSL_mod(nn.Module):

    def __init__(self, args):
        super(SSL_mod, self).__init__()
        #self.img_x_storage = None  # Instance attribute
    ...
    def forward(self, x, risk_factors=None, batch=None):
        ...
        #print("Transformer output shape:", transformer_hidden[:3])

        return logit, transformer_hidden, activ_dict, img_x, transformer_hidden