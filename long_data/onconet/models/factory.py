...
def get_model_by_name(name, allow_wrap_model, args):
    ...
    allow_data_parallel = 'discriminator' not in name and ('SSL_mod' not in args.model_name or allow_wrap_model)
...
def wrap_model(model, allow_wrap_model, args, allow_data_parallel=True):
    try:
        ...
        pass
    if args.multi_image and not args.model_name in ['SSL_mod']:
